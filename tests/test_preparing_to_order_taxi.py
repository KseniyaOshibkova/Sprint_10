...
class TestPreparingToOrderTaxi:
    ...
    def test_switch_optimal_fast_route_recalculation(self, driver, preparing_to_order_taxi_page):
        preparing_to_order_taxi_page.prepare_addresses()
    ...
    def test_custom_mode_activates_move_types(self, driver, preparing_to_order_taxi_page):
        preparing_to_order_taxi_page.prepare_addresses()
    ...
    def test_fast_mode_call_taxi_button_active(self,  driver, preparing_to_order_taxi_page):
        preparing_to_order_taxi_page.prepare_addresses()
    ...
    def test_custom_mode_drive_booking_button(self,  driver, preparing_to_order_taxi_page):
        preparing_to_order_taxi_page.prepare_addresses()
