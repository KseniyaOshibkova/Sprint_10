...
class TestDrawingRouteSelectionBlock:
    ...
    def test_route_selection_block_with_different_addresses(self, driver, drawing_route_with_selection_page):
    ...
    def test_route_selection_block_with_equal_addresses(self, driver, drawing_route_with_selection_page):
